...
const pageTitle = computed(() => t('auth.register.title'));
const pageDescription = computed(() => t('auth.register.description'));
const pageHeadTitle = computed(() => t('auth.register.head_title'));
const pageEyebrow = computed(() => t('auth.register.eyebrow'));
const submitLabel = computed(() => t('auth.register.submit'));
const dividerLabel = computed(() => t('auth.register.divider'));
</script>
