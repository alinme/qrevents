...
<template>
    ...
    >
        ...
        <div
            class="mb-4 rounded-[20px] border border-promo-line bg-promo-surface px-4 py-3 text-sm text-promo-ink"
        >
        ...
        >
            <div class="grid gap-4">
                <div class="grid gap-2">
                    <Label for="invited-email" class="text-promo-ink">
                        Email
                    </Label>
                    <Input
                        id="invited-email"
        ...
        <form v-else class="flex flex-col gap-6" @submit.prevent="submitLogin">
            <div class="grid gap-4">
                <div class="grid gap-2">
                    <Label for="invited-email-login" class="text-promo-ink">
                        Email
                    </Label>
                    <Input
                ...
                <div class="grid gap-2">
                    <Label for="login-password" class="text-promo-ink">
                        Password
                    </Label>
                    <PasswordInput
                        id="login-password"
