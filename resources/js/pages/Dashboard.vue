...
import { badgeClass, moderationBadgeClass } from '@/lib/dashboard';
...
const compactStats = computed(() => [
    {
        ...
        detail: t('dashboard.stats.events_detail', {
            count: formatNumber(props.summary.ownedEventCount),
        }),
        icon: FolderKanban,
    },
    {
...
const ownerName = computed(
    () => page.props.auth?.user?.name ?? t('dashboard.owner_fallback'),
);
...
const planSummary = (event: DashboardEvent): string =>
    [
        ...
        t('dashboard.plan.uploads', {
            count: formatNumber(event.planDetails.uploadLimit),
        }),
            ...
            <div class="dashboard-shell max-w-6xl">
                <section class="dashboard-panel">
                    ...
                    >
                        ...
                        <dl
                            class="grid gap-x-6 gap-y-4 sm:grid-cols-2 xl:grid-cols-4"
                        >
                            <div
                    ...
                    >
                        <div>
                            <p class="text-sm font-semibold text-amber-950">
                                {{
                                    t('dashboard.continue_setup.title', {
                                        event: continueSetupEvent.name,
                                    })
                                }}
                            </p>
                        ...
                        >
                            <div>
                                ...
                                <p class="dashboard-body mt-1">
                                    {{
                                        t(
                                            'dashboard.sections.events.description',
                                        )
                                    }}
                                </p>
                            </div>
                            <p class="text-sm text-brand-muted">
                                {{
                                    t('dashboard.sections.events.total', {
                                        count: formatNumber(
                                            totalAccessibleEvents,
                                        ),
                                    })
                                }}
                            </p>
                                        ...
                                        <div class="min-w-0 space-y-2">
                                            ...
                                            <div>
                                                ...
                                                >
                                                    {{
                                                        t(
                                                            'dashboard.event_summary.inline',
                                                            {
                                                                date: formatLocalizedDateOnly(
                                                                    event.eventDate,
                                                                ),
                                                                guests: formatNumber(
                                                                    event.guestCount,
                                                ...
                                                <p class="dashboard-meta mt-1">
                                                    {{
                                                        event.lastUploadAt
                                                            ? t(
                                                                  'dashboard.event_summary.last_upload',
                                                                  {
                                                            ...
                                                            : t(
                                                                  'dashboard.event_summary.no_uploads',
                                                              )
                                                    }}
                                                </p>
                                                <p class="dashboard-meta mt-1">
                                                ...
                                                >
                                                    <span
                                                        v-for="capability in planCapabilities(
                                                            event,
                                                        )"
                                        ...
                                        <div class="min-w-0 space-y-2">
                                            ...
                                            <div>
                                                ...
                                                >
                                                    {{
                                                        t(
                                                            'dashboard.event_summary.shared_inline',
                                                            {
                                                                date: formatLocalizedDateOnly(
                                                                    event.eventDate,
                                                                ),
                        ...
                        <div class="flex min-h-0 w-full flex-col">
                            ...
                            >
                                ...
                                <p class="dashboard-body">
                                    {{
                                        t(
                                            'dashboard.sections.activity.description',
                                        )
                                    }}
                                </p>
                            </div>
                                    ...
                                    >
                                        <div class="min-w-0">
                                            <p class="text-sm text-brand-ink">
                                                {{
                                                    t(
                                                        'dashboard.sections.activity.item',
                                                        {
