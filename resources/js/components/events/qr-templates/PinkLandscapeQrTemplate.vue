...
<template>
    <article :style="fontVariables" class="qr-template qr-template-pink-landscape relative mx-auto aspect-[1.4142/1] h-full max-h-[calc(100vh-15rem)] w-full max-w-[1100px] overflow-hidden rounded-[2rem] shadow-[0_34px_80px_rgba(76,41,52,0.15)]">
