...
<template>
    <article
        class="invitation-sheet relative isolate aspect-[1240/1748] w-full overflow-hidden rounded-[2rem] border border-black/8 shadow-[0_28px_80px_rgba(40,24,12,0.14)]"
        :style="sheetStyle"
    >
